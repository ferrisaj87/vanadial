...
local VD_COMMANDS = {
    ...
    { '/vd boats',       'Open the timers popup with ferry boats expanded (Selbina/Mhaura/Whitegate/Nashmau). Run again to close the popup.' },
    { '/vd boatsall',    'Open the timers popup with all boat sub-groups expanded. Run again to close the popup.' },
    { '/vd manaclipper', 'Open the timers popup with Bibiki Manaclipper expanded. Run again to close the popup.' },
